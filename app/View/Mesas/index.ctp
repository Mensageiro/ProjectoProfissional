...
<div class="col-md-12">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('qtd_lugar'); ?></th>
			<th><?php echo $this->Paginator->sort('posicao'); ?></th>
			<th><?php echo $this->Paginator->sort('created'); ?></th>
			<th><?php echo $this->Paginator->sort('modified'); ?></th>
			<th><?php echo $this->Paginator->sort('servente_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($mesa['Mesa']['qtd_lugar']); ?>&nbsp;</td>
		<td><?php echo h($mesa['Mesa']['posicao']); ?>&nbsp;</td>
